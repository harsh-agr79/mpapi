...
<body>
    ...
    <div class="section">
        ...
        <div class="order-info">
            <p><strong>Name:</strong> <span style="text-transform: capitalize;">{{ $order->billing_full_name }}</span>
            </p>
    ...
    <div class="section">
        ...
        <div class="order-info">
            <p><strong>Name:</strong> <span style="text-transform: capitalize;">{{ $order->shipping_full_name }}</span>
            </p>
